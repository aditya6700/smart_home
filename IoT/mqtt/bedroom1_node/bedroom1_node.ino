...
Adafruit_MQTT_Publish bedroom1_pub = Adafruit_MQTT_Publish(&mqtt, MQTT_USERNAME "/pi/bedroom1");

// Setup a feed called 'esp8266_con' for subscribing to changes.   
Adafruit_MQTT_Subscribe esp8266_con = Adafruit_MQTT_Subscribe(&mqtt, MQTT_USERNAME "/esp8266/bedroom1");
...
//      Serial.println(json_string3);  Serial.println(json_string4);
     ...
     // publishing data to bedroom1
      bool p1 = bedroom1_pub.publish(json_string1); delay(1000);
      bool p2 = bedroom1_pub.publish(json_string2); delay(1000);
      bool p3 = bedroom1_pub.publish(json_string3); delay(1000);
      bool p4 = bedroom1_pub.publish(json_string4);  
