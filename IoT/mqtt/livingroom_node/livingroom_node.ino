...
Adafruit_MQTT_Publish livingroom_pub = Adafruit_MQTT_Publish(&mqtt, MQTT_USERNAME "/pi/livingroom");
...
//      Serial.println(json_string3);  Serial.println(json_string4);
     ...
     // publishing data to livingroom
      bool p1 = livingroom_pub.publish(json_string1); delay(1000);
      bool p2 = livingroom_pub.publish(json_string2); delay(1000);
      bool p3 = livingroom_pub.publish(json_string3); delay(1000);
      bool p4 = livingroom_pub.publish(json_string4);  
