           ...
           <div className="container-fluid ml-2">
                <div className="row">
                    <div className='col-12 mx-auto'>
                        <div className="row">
                            <div className="headerintro col-lg-5  mx-auto pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                            ...
                            <div className="home_carousel col-lg-7 col-12 mx-auto order-1 order-lg-2  ">
                                 <Carousel />
                            </div>
                        </div>
                    </div>
